...
namespace PLAYER
{
	...
	/* GET_PLAYER_PED_SCRIPT_INDEX was renamed to GET_PLAYER_PED*/
	static Ped GET_PLAYER_PED(Player player) { return invoke<Ped>(0x50FAC3A3E030A6E1, player); } // 0x50FAC3A3E030A6E1 0x6AC64990

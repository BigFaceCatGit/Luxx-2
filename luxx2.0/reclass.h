#ifndef ALPHA_RECLASS_H
#define ALPHA_RECLASS_H
...
public:
	...
	float fWantedLvlCanChange; //0x001C 
	char pad_0x0020[0x10]; //0x0020
	v3 v3WantedCenterPos; //0x0030 
	char pad_0x003C[0x4]; //0x003C
	v3 v3WantedCenterPos2; //0x0040 
	char pad_0x004C[0x38]; //0x004C
	BYTE bt_Flag0; //0x0084 
	BYTE bt_Flag1; //0x0085 
	BYTE bt_Flag2; //0x0086 
	BYTE bt_Flag3; //0x0087 
	char pad_0x0088[0xC]; //0x0088
	DWORD dwFakeWantedLvl; //0x0094 
	DWORD dwWantedLvl; //0x0098 
...
public:
	...
	void removeWanted()
	{
		if (CWantedData.dwWantedLvl > 0)
			CWantedData.dwWantedLvl = 0;
	}
}; //Size=0x0C08
